            ...
            <div v-show="showAdvanceSearchVisible"
                ...
                <el-row>
                    <el-col :span="5">
                        ...
                        <el-select v-model="searchValue.politicId"
                                   size="mini" style="width: 130px" placeholder="政治面貌">
                            <el-option
                ...
                <el-row style="margin-top: 10px">
                    ...
                    <el-col :span="5" :offset="4">
                        ...
                        <el-button @click="initEmps('advanced')"
                                   size="mini" icon="el-icon-search" type="primary">搜索
                        </el-button>
                    </el-col>
                </el-row>
            </div>
        ...
        methods: {
            ...
            initData() {
                if (!window.sessionStorage.getItem('nations')) {
                    this.getRequest('/employee/basic/na').then(resp => {
                        if (resp) {
                            this.nations = resp;
                ...
                if (!window.sessionStorage.getItem('joblevels')) {
                    this.getRequest('/employee/basic/jl').then(resp => {
                        if (resp) {
                            this.joblevels = resp;
                ...
                if (!window.sessionStorage.getItem('politicsstatus')) {
                    this.getRequest('/employee/basic/pol').then(resp => {
                        if (resp) {
